...
function useReskaNavData(): NavSectionProps['data'] {
    return useMemo(
        () => [
            {
                subheader: 'RESKA PANELI',
                items: [
                    {
                        title: 'Jarayonda',
                        path: '/reska-panel/jarayonda',
                        icon: (
...
export function ReskaPanelLayout({ children }: Props) {
    const navData = useReskaNavData();
