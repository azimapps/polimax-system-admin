...
function useLaminatsiyaNavData(): NavSectionProps['data'] {
    return useMemo(
        () => [
            {
                subheader: 'LAMINATSIYA PANELI',
                items: [
                    {
                        title: 'Jarayonda',
                        path: '/laminatsiya-panel/jarayonda',
                        icon: (
                    ...
                    {
                        title: 'Yakunlangan',
                        path: '/laminatsiya-panel/finished',
                        icon: (
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    {
                        title: 'Materiallar',
                        path: '/laminatsiya-panel/materials',
                        icon: (
...
export function LaminatsiyaPanelLayout({ children }: Props) {
    const navData = useLaminatsiyaNavData();
