...
import { FinanceType, PaymentMethod } from 'src/types/finance';
...
export function CashView() {
    ...
    return (
        <Container maxWidth="xl">
            <CustomBreadcrumbs
                heading={t('cash_title')}
                links={[
                    { name: 'Dashboard', href: paths.dashboard.root },
                    { name: t('finance'), href: paths.dashboard.finance.root },
                    { name: t('cash') },
                ]}
                action={
            ...
            <FinanceDialog
                ...
                id={selectedId}
                defaultPaymentMethod={PaymentMethod.NAQD}
            />
