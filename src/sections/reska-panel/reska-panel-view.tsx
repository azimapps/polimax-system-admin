...
export function ReskaPanelView() {
    ...
    if (currentTab === 'jarayonda') {
        return (
            <Container maxWidth="xl" sx={{ py: 3, display: 'flex', gap: 3 }}>
                <InProgressView machineType={StanokType.RESKA} translationNs="reska-panel" />
            </Container>
        );
    }
    ...
    if (currentTab === 'materials') {
        return (
            <Container maxWidth="xl" sx={{ py: 3, display: 'flex', gap: 3 }}>
                <MaterialsView machineType={StanokType.RESKA} translationNs="reska-panel" />
            </Container>
        );
    }
    ...
    if (currentTab === 'finished') {
        return (
            <Container maxWidth="xl" sx={{ py: 3, display: 'flex', gap: 3 }}>
                <FinishedView machineType={StanokType.RESKA} translationNs="reska-panel" />
            </Container>
        );
    }
    ...
    return (
        <Container maxWidth="xl" sx={{ py: 3, display: 'flex', gap: 3 }}>
            <SushkaView translationNs="reska-panel" />
        </Container>
    );
}
