...
[
  {
    ...
    "brigada_name": "Smena 1",
    "machine_name": "Heidelberg Speedmaster"
  }
]
```

> **Enriched fields:** `order_number`, `order_title`, `brigada_name`, `machine_name` — фронтенд учун қўшимча сўровлар керак эмас.
...
[
  ...
  },
  {
    ...
    "created_at": "...",
    "updated_at": "...",
    "brigada_name": "Smena 2",
    "machine_name": "Sushka Machine 1"
  }
]
```
...
| `brigada_name` | Бригада номи |
| `machine_id` | Қайси станокда |
| `machine_name` | Станок номи |
...
**Role:** `accountant` | `ceo` | brigada leader
...
[
  {
    ...
    "created_at": "...",
    "from_brigada_name": "Smena 1",
    "to_brigada_name": "Smena 2",
    "from_step_type": "pechat",
    "to_step_type": "sushka"
  }
]
```
...
| Field | Description |
|-------|-------------|
| `from_brigada_name` | Юборган бригада номи |
| `to_brigada_name` | Қабул қилган бригада номи |
| `from_step_type` | Қайси степдан (`reska`, `pechat`, ...) |
| `to_step_type` | Қайси степга |
